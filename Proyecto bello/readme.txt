...
Aquí puede buscar un alumno insertando la matrícula y se mostrarán todos su información.

##### Modificar datos
Si desea modificar un dato, es necesario insertar la matrícula del alumno.
...
##### Eliminar alumno
Para eliminar a un alumno definitivamente, inserte la matrícula.
1. Eliminar
2. Cancelar
